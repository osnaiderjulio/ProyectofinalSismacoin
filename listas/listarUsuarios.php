      ...
      <tbody>
        ...
        ?>
          <tr>
            ...
            <td style="text-align:center"><a href="../procesos/eliminarusuarios.php?iduser'=<?php echo $row['ID'] ?>"> <button type="button" class="btn btn-danger" onclick="return confirmDelete()"><i class="bi bi-trash"></i></button></a></td>
          </tr>
        <?php endwhile; ?>
      </tbody>
    </table>
