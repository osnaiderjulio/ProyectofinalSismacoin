...
//mysqli_close($cx);
//}
$Cod_clientes = $_REQUEST['Cod_clientes'];
$obj->obtenDatosUsuario($Cod_clientes);
                ...
                <form action="../procesos/actualizarclientes.php" method="post" class="row g-3 needs-validation">
                    ...
                    <div class="col-md-6 position-relative">
                        <div class="form-outline">
                            ...
                            <input type="text" class="form-control" name="Cod_clientes" value="<?php echo $Cod_clientes ?>" required />
