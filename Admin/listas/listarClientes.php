      ...
      <tbody>
        ...
        ?>
          <tr>
            ...
            <td style="text-align:center"><a href="../inactivar/inactivarcliente.php?Cod_clientes=<?php echo $ver[0] ?>"> <button type="button" class="btn btn-danger" onclick="return confirmDelete()"><i class="bi bi-trash"></i></button></a></td>
          </tr>
        <?php endwhile; ?>
      </tbody>
    </table>
