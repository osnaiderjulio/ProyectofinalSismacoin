        ...
        <div class=" card container mt-2">
            <div class="row g-3">
                ...
                <h1 class="text-center"><span class="badge bg-primary mb-4 rounded-pill text-dark">ACTUALIZAR USUARIO</span></h1>
                    ...
                    <div class="col-md-4 position-relative">
                        <label for="validationTooltip02" class="form-label">Cargo</label>
                    ...
                    <div class="col-md-4 position-relative">
                        <label for="validationTooltip02" class="form-label">Género</label>
                        <select name="genero" value="<?php echo $ver[12] ?>"  class="form-select" aria-label="Default select example">
                    ...
                    <div class="col-md-4 position-relative">
                        <div class="form-outline">
                            ...
                            <input type="text" class="form-control" name="edad" value="<?php echo $ver[13] ?>" required />
